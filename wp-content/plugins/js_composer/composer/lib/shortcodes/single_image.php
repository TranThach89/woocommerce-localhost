...
class WPBakeryShortCode_AZ_Single_Image extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		...
		if ($image_link == "yes") {
			...
			$img_output = '<img class="'.$image_mode.' '.$image_alignment.' '.$animation_loading_class.' '.$animation_effect_class.' '.$el_class.'" '.$animation_delay_class.' alt="'.$image_title.'" src="'. $image_string .'" />';
		}
