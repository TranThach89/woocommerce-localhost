<?php
/*
Plugin Name: AZ Page Builder
Plugin URI: http://www.alessioatzeni.com
Description: Create content without headaches with simple drag-n-drop interface. Slightly Modified Version of Original WPBakery Visual Composer for <strong>Skadi Theme</strong> Only.
...
if( !$vc_as_theme && is_file(get_template_directory() . '/wpbakery/js_composer/js_composer.php') ) {
    ...
    if (!defined('WPB_VC_VERSION')) define('WPB_VC_VERSION', '3.6.2');
