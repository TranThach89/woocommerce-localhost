<form name="" action="" method="post">
    ...
    <label for="izw_check_order_total">
        <input name="izw_check_order_total" type="checkbox" id="izw_check_order_total" <?php if( $izw_check_order_total == '1'  && $izw_check_order_total ) echo 'checked="checked" ' ?> value="1">
