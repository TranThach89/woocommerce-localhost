 ...
 */
/**
 * Plugin Name: Promolizers Custom Plugin Sever
 * Plugin URI:  https://bitbucket.org/thanhluanft20/promolizers-custom-plugin
 * Description: Send digests with forum's active topics.
 * Author:      Izweb Team
 * Author URI:  http://izweb.biz
 * Version:     0.1
 * Text Domain: izwpromolizers
 * Domain Path: /languages/
 * License:     GPL
 */

define( '__TEXTDOMAIN__', 'izwpromolizers' );
...
class Promolizers_Custom_Plugin{
    function __construct(){
        ...
        add_filter( 'woocommerce_shipping_methods', array( $this, 'add_promo_shipping_method' ) );
    }
    ...
    function init(){
        ...
        include_once (__PROMOPATH__."/includes/class-promo-shipping.php");
    }
    ...
    function activation(){
        ...
        if($version != __DBVERSION){ // Check db version
     ...
     * @param $update
     */
    function auto_increment_item( $post_ID, $post, $update ){
    ...
    /**
     * Add Promo shipping method
     *
     * @param $methods
     * @return array
     */
    function add_promo_shipping_method( $methods ) {
        $methods[] = 'IZW_Promo_Shipping';
        return $methods;
    }

}
$GLOBALS['izwpromolizers'] = new Promolizers_Custom_Plugin();
